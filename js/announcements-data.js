/* ===========================================================================
   ...
   image / extraImages use ROOT-RELATIVE paths ("/assets/...") so the same
   data renders correctly from / and from /pl/. link.href stays RELATIVE on
   purpose, so each language resolves to its own event page.
   =========================================================================== */
