...
if (!exists("dist")) {
  ...
  if (missingProof.length === 0) {
    ...
    const MIGRATED = ["team.html", "pl/team.html", "announcements.html", "pl/announcements.html",
      ...
      // Phase 13 added the bilingual events listing.
...
if (exists("dist")) {
  // Standard event pages ARE generated as of Phase 11, the Business Forum as of
  // Phase 12, and the events listing as of Phase 13. The homepages are not.
  const forbiddenGenerated = ["dist/index.html", "dist/pl/index.html"];
  const created = forbiddenGenerated.filter((p) => exists(p));
  assert(created.length === 0,
    "no homepage has been generated",
...
if (!exists("dist")) {
  ...
  if (evMissingPages.length === 0) {
    ...
    const forbidden = ["dist/index.html", "dist/pl/index.html"];
    const created = forbidden.filter((p) => exists(p));
    assert(created.length === 0,
      "no homepage was generated by this phase",
...
if (!exists("dist")) {
  ...
  // No homepage, and the sitemap is untouched by this phase.
  assert(!exists("dist/index.html") && !exists("dist/pl/index.html"),
    "no homepage was generated by this phase",
    "a homepage appeared in dist/");
  {
    const { execFileSync } = require("child_process");
    let changed = null;
    try {
